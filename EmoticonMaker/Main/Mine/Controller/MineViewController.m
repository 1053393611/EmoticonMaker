...
- (void)viewDidLoad {
    ...
    } else if ([_personname isEqualToString:@"我发送的"] ) {
        scImagePath = [NSHomeDirectory() stringByAppendingPathComponent:@"Documents/fasong"];
    }
    ...
    scbtn.imageEdgeInsets = UIEdgeInsetsMake(5, 70, 5, 10);
...
//        path = [scImagePath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.gif",_imagearray[indexPath.row]]];
        NSURL *url = [NSURL fileURLWithPath:[scImagePath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.gif",_imagearray[indexPath.row]]]];
        NSData *data = [NSData dataWithContentsOfURL:url];
       // scImage = [UIImage sd_animatedGIFWithData:data];
        scImage = [UIImage imageWithData:data];
    }else {
       // path = [scImagePath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.png",_imagearray[indexPath.row]]];
        scImage = [UIImage imageWithContentsOfFile:[scImagePath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.png",_imagearray[indexPath.row]]]];
    }
...
//    smallview.backgroundColor = [UIColor redColor];
    ...
    NSArray *imgarray = @[@"wechat",@"qqshare",@"del"];
